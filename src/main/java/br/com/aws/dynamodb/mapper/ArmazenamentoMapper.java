...
public interface ArmazenamentoMapper {
    ...
    public static List<Aluguel> mapToDomain(List<AluguelEntity> aluguelEntity){
        return aluguelEntity.stream().map(ArmazenamentoMapper::mapToDomain).collect(Collectors.toList());
    }
    ...
    public static List<AluguelResponse> mapToResponse(List<Aluguel> aluguel) {
        return aluguel.stream().map(ArmazenamentoMapper::mapToResponse).collect(Collectors.toList());
    }
