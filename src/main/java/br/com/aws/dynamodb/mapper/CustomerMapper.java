...
public interface CustomerMapper {
    ...
    public static List<Customer> mapToDomain(List<CustomerEntity> customerEntity){
        return customerEntity.stream().map(CustomerMapper::mapToDomain).collect(Collectors.toList());
    }
    ...
    public static List<CustomerResponse> mapToResponse(List<Customer>country) {
        return country.stream().map(CustomerMapper::mapToResponse).collect(Collectors.toList());
    }
